"""POST /speak — REST wrapper around voicetuner.speak for non-MCP callers.
...
bindings (via X-VoiceTuner-Client-Id) work identically.
"""
...
async def speak(
    ...
    """Speak text in a voice profile. Mirrors voicetuner.speak (MCP).
    ...
    if profile is None:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                "or configure a default in VoiceTuner → Settings → MCP."
            ),
        )
