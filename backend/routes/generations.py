...
async def stream_speech(
    ...
    from ..services.speech_router import resolve_tts_engine, NoSpeechProviderError

    try:
        engine = resolve_tts_engine(engine, data.language or "en")
    except NoSpeechProviderError as e:
