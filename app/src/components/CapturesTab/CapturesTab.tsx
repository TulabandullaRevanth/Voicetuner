                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      ...
                      {capture.identified_profile_name && (
                        <Badge
                          variant="secondary"
                          className="h-5 px-1.5 text-[10px] gap-1 font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/20"
                        >
        ...
        {selected ? (
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4 text-xs text-muted-foreground flex-wrap">
              ...
              {selected.identified_profile_name && (
                <>
                  <span className="text-muted-foreground/40">·</span>
                  <span className="flex items-center gap-1 text-emerald-400">
                    <User className="h-3 w-3" />
                    {selected.identified_profile_name}
                    {selected.speaker_confidence != null && (
                      <span className="text-muted-foreground/60">
                        ({Math.round(selected.speaker_confidence * 100)}%)
                      </span>
                    )}
                  </span>
                </>
