...
2. Email security details to: [security@voicetuner.app](mailto:security@voicetuner.app)
3. Include:
...
- **Keep VoiceTuner updated** - Updates include security patches
...
VoiceTuner processes all audio locally by default. Your voice data never leaves your machine unless you explicitly enable remote server mode.
...
Thank you for helping keep VoiceTuner secure! 🔒
