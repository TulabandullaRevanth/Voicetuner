...
//! VoiceTuner itself" and short-circuit the synthetic-paste path. On
//! Windows, `bundle_id` holds the lowercased exe basename (`"voicetuner.exe"`)
...
mod win {
    ...
    /// (e.g. `"voicetuner.exe"`). This is the Windows analogue of macOS'
