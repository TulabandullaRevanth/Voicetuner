...
VoiceTuner keeps a complete history of all generated audio, making it easy to find, reuse, and manage your creations.
...
- **macOS**: `~/Library/Application Support/sh.voicetuner.app/data/`
- **Windows**: `%APPDATA%/sh.voicetuner.app/data/`
- **Linux**: `~/.config/sh.voicetuner.app/data/`
