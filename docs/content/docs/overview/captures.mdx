...
how VoiceTuner strips Whisper loop hallucinations *before* the LLM sees the
...
The original audio is kept alongside the transcript in your VoiceTuner data
...
[Remote Mode](/overview/remote-mode) for running VoiceTuner as a server the rest
