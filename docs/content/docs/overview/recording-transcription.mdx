...
description: "A map of the three places you can record and transcribe audio in VoiceTuner — dictation, captures, and voice-profile samples."
---

## Overview

VoiceTuner records and transcribes audio in three different contexts, each
...
| Record a thought, a meeting, or a voice memo inside VoiceTuner | Captures tab | [Captures](/overview/captures) |
...
<Callout type="info">
  ...
  hard inputs — most famously the "thanks for watching" loop. VoiceTuner
