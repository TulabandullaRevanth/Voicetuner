---
title: "Installation"
description: "Download and install VoiceTuner on macOS, Windows, or Linux"
---

## Download

VoiceTuner is available for macOS and Windows, with Linux builds coming soon.
...
<Tabs items={["Apple Silicon", "Intel"]}>
  <Tab value="Apple Silicon">
    Download: [voicetuner_aarch64.app.tar.gz](https://github.com/umadevi16177/voice_tuner/releases/latest/download/voicetuner_aarch64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf voicetuner_aarch64.app.tar.gz

    # Move to Applications
    mv VoiceTuner.app /Applications/
    ```
  </Tab>
  <Tab value="Intel">
    Download: [voicetuner_x64.app.tar.gz](https://github.com/umadevi16177/voice_tuner/releases/latest/download/voicetuner_x64.app.tar.gz)

    ```bash
    # Extract the archive
    tar -xzf voicetuner_x64.app.tar.gz
...
<Tabs items={["MSI Installer", "Setup Executable"]}>
  <Tab value="MSI Installer">
    Download: [voicetuner_x64_en-US.msi](https://github.com/umadevi16177/voice_tuner/releases/latest/download/voicetuner_x64_en-US.msi)

    Double-click the MSI file and follow the installation wizard.
  </Tab>
  <Tab value="Setup Executable">
    Download: [voicetuner_x64-setup.exe](https://github.com/umadevi16177/voice_tuner/releases/latest/download/voicetuner_x64-setup.exe)
...
When you launch VoiceTuner for the first time:
...
2. **Data Directory** — Voice profiles and generated audio are stored in:
   - macOS: `~/Library/Application Support/sh.voicetuner.app/`
   - Windows: `%APPDATA%/sh.voicetuner.app/`
   - Linux: `~/.config/sh.voicetuner.app/`
