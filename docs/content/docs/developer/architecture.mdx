---
title: "Architecture"
description: "Understanding VoiceTuner's technical architecture"
---

## System Overview

VoiceTuner uses a client-server architecture with a React frontend and Python backend. The desktop app is built with Tauri and contains two main layers:
...
See [TTS Engines](/developer/tts-engines) for the full contract and integration phases, and [PROJECT_STATUS.md](https://github.com/umadevi16177/voice_tuner/blob/main/docs/PROJECT_STATUS.md) for candidates under evaluation.
