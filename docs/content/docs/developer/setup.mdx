...
description: "Set up your local development environment for VoiceTuner"
---
...
| `just build-server-cuda` | **Windows:** CUDA server binary only, placed in `%APPDATA%/sh.voicetuner.app/backends/cuda` for local testing |
