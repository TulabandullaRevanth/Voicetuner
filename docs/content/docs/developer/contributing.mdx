---
title: "Contributing"
description: "How to contribute to VoiceTuner"
---

Thank you for your interest in contributing to VoiceTuner! This guide will help you get started.
...
1. **Read the documentation** to understand how VoiceTuner works
...
4. **Checked [`docs/PROJECT_STATUS.md`](https://github.com/umadevi16177/voice_tuner/blob/main/docs/PROJECT_STATUS.md)** — the living engineering roadmap that tracks prioritized tasks (Tier 1 → 3), architectural bottlenecks, and candidate TTS engines under evaluation (including why some are backlogged)
...
<Files>
  <Folder name="voicetuner" defaultOpen>
    <Folder name="app/src">
...
- Check [existing issues](https://github.com/umadevi16177/voice_tuner/issues) for bugs
- Test your fix thoroughly
- Add regression tests if possible

### New Features

- Check [`docs/PROJECT_STATUS.md`](https://github.com/umadevi16177/voice_tuner/blob/main/docs/PROJECT_STATUS.md) and the [roadmap](https://github.com/umadevi16177/voice_tuner#roadmap) before proposing work — the status doc lists prioritized tasks (Tier 1 → 3), known architectural bottlenecks, and candidate TTS engines already under evaluation (including why some have been backlogged)
...
- [CHANGELOG.md](https://github.com/umadevi16177/voice_tuner/blob/main/CHANGELOG.md)
...
2. Read [`docs/PROJECT_STATUS.md`](https://github.com/umadevi16177/voice_tuner/blob/main/docs/PROJECT_STATUS.md) for current engineering priorities
3. Search [existing issues](https://github.com/umadevi16177/voice_tuner/issues)
4. Open a new issue or discussion
5. See [CONTRIBUTING.md](https://github.com/umadevi16177/voice_tuner/blob/main/CONTRIBUTING.md) in the repo
