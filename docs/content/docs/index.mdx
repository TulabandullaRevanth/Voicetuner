---
title: "VoiceTuner Documentation"
description: "VoiceTuner is the open-source, local-first AI voice studio — a free alternative to ElevenLabs and WisprFlow, running entirely on your machine."
---

VoiceTuner is the **open-source, local-first AI voice studio** — a free
...
![VoiceTuner App Screenshot](/images/app-screenshot-1.webp)
...
- **Agents speak back** — any MCP-aware agent can call VoiceTuner to speak in one of your cloned voices
...
[View all releases](https://github.com/umadevi16177/voice_tuner/releases/latest)

## Get Started

- [Installation](/overview/installation) — download and install VoiceTuner
