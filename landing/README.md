# VoiceTuner Landing Page

Landing page for voicetuner.app - a modern Next.js 16 application.
...
5. Configure custom domain `voicetuner.app` in Railway settings
...
├── public/
│   └── voicetuner-logo.png   # Logo asset
