# Contributing to VoiceTuner

Thank you for your interest in contributing to VoiceTuner! This document provides guidelines and instructions for contributing.
...
```bash
git clone https://github.com/YOUR_USERNAME/voicetuner.git
cd voicetuner
...
This builds the CPU sidecar (bundled with the app), the CUDA binary (placed in `%APPDATA%/com.voicetuner.app/backends/` for runtime GPU switching), and the installable Tauri app.
...
Thank you for contributing to VoiceTuner! 🎉
